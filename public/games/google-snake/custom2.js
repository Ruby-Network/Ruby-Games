window.snake_scheme_epic_cool = window.snake_scheme_epic_cool || { light_squares: '#AAD751', dark_squares:  '#A2D149' };
  ...
  // micro
  let img = new Image;
  img.src = 'snake_arcade/Micro.png?raw=true';
  img.width = 47;
  img.height = 47;
  ...
  // tiny
  img = new Image;
  img.src = 'snake_arcade/Tiny.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // super big
  img = new Image;
  img.src = 'snake_arcade/Super%20Big.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // ultra big
  img = new Image;
  img.src = 'snake_arcade/Too%20Big.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // humongous
  img = new Image;
  img.src = 'snake_arcade/Humongous.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // too big
  img = new Image;
  img.src = 'snake_arcade/Way%20Too%20Big.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#size').appendChild(img);
  ...
  // blursed
  img = new Image;
  img.src = 'snake_arcade/blursed.png?raw=true';
  img.width = 47;
  img.height = 47;
  ...
  // lightning
  img = new Image;
  img.src = 'snake_arcade/lightning.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // snail
  img = new Image;
  img.src = 'snake_arcade/Snail.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  img = new Image;
  img.src = 'snake_arcade/Faster%20And%20Slower.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // desert bus
  img = new Image;
  img.src = 'snake_arcade/Desert%20Bus.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // bullet
  img = new Image;
  img.src = 'snake_arcade/Bullet.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // hyperbullet (red)
  img = new Image;
  img.src = 'snake_arcade/Red%20bullet.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // ultrabullet (purple)
  img = new Image;
  img.src = 'snake_arcade/Purple%20bullet.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // yeetbullet (blue)
  img = new Image;
  img.src = 'snake_arcade/Blue%20Bullet.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // eternity
  img = new Image;
  img.src = 'snake_arcade/eternal.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // ultradeath
  img = new Image;
  img.src = 'snake_arcade/ultradeath.png?raw=true';
  img.width = 47;
  img.height = 47;
  img.class = 'DqMRee SsAred';
  document.querySelector('#speed').appendChild(img);
  ...
  // 13
  img = new Image;
  img.src = 'snake_arcade/13.png?raw=true';
  img.width = 47;
  img.height = 47;
  ...
  // 25
  img = new Image;
  img.src = 'snake_arcade/25.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // 40 :rolling_eyes:
  img = new Image;
  img.src = 'snake_arcade/40.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // 87
  img = new Image;
  img.src = 'snake_arcade/87.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // apple bomb
  img = new Image;
  img.src = 'snake_arcade/Apple%20Bomb.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
  ...
  // apple nuke
  img = new Image;
  img.src = 'snake_arcade/nuke.png?raw=true';
  img.width = 47;
  img.height = 47;
  document.querySelector('#count').appendChild(img);
    ...
    req.onload = function () {
      ...
      thing.onmousemove = thing.onclick = function() {
        ...
        if(count_ === 3) {
          ...
          [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
          __c = new Image;
          __c.src = 'snake_arcade/13.png?raw=true';
        ...
        if(count_ === 4) {
          ...
          [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
          __c = new Image;
          __c.src = 'snake_arcade/25.png?raw=true';
          __c.width = __c.height = 47;
          __c.style = 'position:fixed;top: 10px;';
          __b.appendChild(__c);
        }
        if(count_ === 5) {
          ...
          [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
          __c = new Image;
          __c.src = 'snake_arcade/40.png?raw=true';
          __c.width = __c.height = 47;
          __c.style = 'position:fixed;top: 10px;';
          __b.appendChild(__c);
        }
        if(count_ === 6) {
          ...
          [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
          __c = new Image;
          __c.src = 'snake_arcade/87.png?raw=true';
          __c.width = __c.height = 47;
          __c.style = 'position:fixed;top: 10px;';
          __b.appendChild(__c);
        }
        if(count_ === 7) {
          ...
          [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
          __c = new Image;
          __c.src = 'snake_arcade/Apple%20Bomb.png?raw=true';
          __c.width = __c.height = 47;
          __c.style = 'position:fixed;top: 10px;';
          __b.appendChild(__c);
        }
        if(count_ === 8) { 
          ...
          [...__b.children].forEach((e, i) => i > 1 && (__b.removeChild(__b.children[i])));
          __c = new Image;
          __c.src = 'snake_arcade/nuke.png?raw=true';
          __c.width = __c.height = 47;
          __c.style = 'position:fixed;top: 10px;';
          __b.appendChild(__c);
        }
