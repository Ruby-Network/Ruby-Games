  ...
  var Ve = function (a) {
    ...
    Af = function () {
      ...
      if (me && ne && (zf(1), !le)) {
        ...
        ge && (P = document.createElement("div"), P.style.transform = "scale(2.722)", P.style.backgroundImage = "url('./logos/pacman10-hp-sprite-3.png')", P.id = "sond99", P.style.position = "absolute", P.style.right = "30px", P.style.top = "30px", P.style.width = "12px", P.style.height = "12px", P.style.border = "10px solid black", P.style.cursor = "pointer", ke.appendChild(P),
